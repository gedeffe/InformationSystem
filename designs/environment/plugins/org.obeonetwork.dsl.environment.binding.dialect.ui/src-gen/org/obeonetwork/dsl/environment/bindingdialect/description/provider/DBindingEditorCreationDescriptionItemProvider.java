 ...
 * @generated
 */
public class DBindingEditorCreationDescriptionItemProvider extends
		RepresentationCreationDescriptionItemProvider implements
	 ...
	 * @generated
	 */
	public DBindingEditorCreationDescriptionItemProvider(
	...
	protected void addDescriptionPropertyDescriptor(final Object object) {
		this.itemPropertyDescriptors
				.add(this.createItemPropertyDescriptor(
						...
						this.getString("_UI_DBindingEditorCreationDescription_description_feature"),
						this.getString(
								"_UI_PropertyDescriptor_description",
								"_UI_DBindingEditorCreationDescription_description_feature",
								"_UI_DBindingEditorCreationDescription_type"),
						DescriptionPackage.Literals.DBINDING_EDITOR_CREATION_DESCRIPTION__DESCRIPTION,
						true, false, true, null, null, null));
	}

	/**
	 * This returns DBindingEditorCreationDescription.gif. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Object getImage(final Object object) {
		return this.overlayImage(
				...
				this.getResourceLocator().getImage(
						"full/obj16/DBindingEditorCreationDescription"));
	}
	...
	public String getText(final Object object) {
		final String label = ((DBindingEditorCreationDescription) object)
				.getName();
		return (label == null) || (label.length() == 0) ? this
				.getString("_UI_DBindingEditorCreationDescription_type") : this
				.getString("_UI_DBindingEditorCreationDescription_type")
				+ " "
				+ label;
	}
