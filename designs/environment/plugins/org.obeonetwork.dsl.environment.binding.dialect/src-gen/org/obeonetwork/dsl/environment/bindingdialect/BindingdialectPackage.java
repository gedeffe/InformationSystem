...
public interface BindingdialectPackage extends EPackage {
	 ...
	 * @generated
	 */
	BindingdialectPackage eINSTANCE = org.obeonetwork.dsl.environment.bindingdialect.impl.BindingdialectPackageImpl
			.init();

	/**
	 * The meta object id for the '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.impl.DBindingEditorImpl
	 * <em>DBinding Editor</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The feature id for the '<em><b>Bound Elements</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Binding Edges</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The number of structural features of the '<em>DBinding Editor</em>'
	...
	/**
	 * The meta object id for the '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.impl.DBindingEdgeImpl
	 * <em>DBinding Edge</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * The meta object id for the '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.impl.DBoundElementImpl
	 * <em>DBound Element</em>}' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 ...
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBindingEditor
	 * <em>DBinding Editor</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBindingEditor#getDescription
	 ...
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBindingEditor#getBoundElements
	 * <em>Bound Elements</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list '
	 *         <em>Bound Elements</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBindingEditor#getBindingEdges
	 * <em>Binding Edges</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list '
	 *         <em>Binding Edges</em>'.
	...
	/**
	 * Returns the meta object for class '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBindingEdge
	 * <em>DBinding Edge</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBoundElement
	 * <em>DBound Element</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBoundElement#getParent
	 ...
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBoundElement#getChildren
	 ...
	 * <em>Edges As Left</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Edges As Right</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference list '
	 * {@link org.obeonetwork.dsl.environment.bindingdialect.DBoundElement#getEdges
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference DBINDING_EDITOR__DESCRIPTION = eINSTANCE
				.getDBindingEditor_Description();

		/**
		 * The meta object literal for the '<em><b>Bound Elements</b></em>'
		 * containment reference list feature. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @generated
		 */
		EReference DBINDING_EDITOR__BOUND_ELEMENTS = eINSTANCE
				.getDBindingEditor_BoundElements();

		/**
		 * The meta object literal for the '<em><b>Binding Edges</b></em>'
		 * containment reference list feature. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @generated
		 */
		EReference DBINDING_EDITOR__BINDING_EDGES = eINSTANCE
				.getDBindingEditor_BindingEdges();

		/**
		 * The meta object literal for the '
		 * {@link org.obeonetwork.dsl.environment.bindingdialect.impl.DBindingEdgeImpl
		 * <em>DBinding Edge</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see org.obeonetwork.dsl.environment.bindingdialect.impl.DBindingEdgeImpl
		 * @see org.obeonetwork.dsl.environment.bindingdialect.impl.BindingdialectPackageImpl#getDBindingEdge()
		...
		/**
		 * The meta object literal for the '<em><b>Left</b></em>' reference
		...
		/**
		 * The meta object literal for the '<em><b>Right</b></em>' reference
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EReference DBOUND_ELEMENT__CHILDREN = eINSTANCE
				.getDBoundElement_Children();

		/**
		 * The meta object literal for the '<em><b>Edges As Left</b></em>'
		 * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EReference DBOUND_ELEMENT__EDGES_AS_LEFT = eINSTANCE
				.getDBoundElement_EdgesAsLeft();

		/**
		 * The meta object literal for the '<em><b>Edges As Right</b></em>'
		 * reference list feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EReference DBOUND_ELEMENT__EDGES_AS_RIGHT = eINSTANCE
				.getDBoundElement_EdgesAsRight();
