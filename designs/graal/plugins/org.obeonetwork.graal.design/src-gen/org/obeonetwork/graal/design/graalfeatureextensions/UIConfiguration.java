 ...
 * <ul>
 * <li>
 * {@link org.obeonetwork.graal.design.graalfeatureextensions.UIConfiguration#getViewpointAnalysis
 * <em>Viewpoint Analysis</em>}</li>
 * <li>
 * {@link org.obeonetwork.graal.design.graalfeatureextensions.UIConfiguration#getActiveUserStories
...
public interface UIConfiguration extends DFeatureExtension {
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Viewpoint Analysis</em>' reference isn't
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Viewpoint Analysis</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Active User Stories</b></em>' reference
	 * list. The list contents are of type
	 * {@link org.obeonetwork.graal.UserStory}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Active User Stories</em>' reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
