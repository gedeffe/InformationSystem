 ...
 * @generated
 */
public class GraalfeatureextensionsSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public GraalfeatureextensionsSwitch() {
	...
	protected T doSwitch(final EClass theEClass, final EObject theEObject) {
		if (theEClass.eContainer() == modelPackage) {
			...
			return eSuperTypes.isEmpty() ? this.defaultCase(theEObject) : this
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		switch (classifierID) {
		case GraalfeatureextensionsPackage.UI_CONFIGURATION: {
			final UIConfiguration uiConfiguration = (UIConfiguration) theEObject;
			T result = this.caseUIConfiguration(uiConfiguration);
			if (result == null) {
				result = this.caseDFeatureExtension(uiConfiguration);
			}
			if (result == null) {
	 ...
	 * <em>UI Configuration</em>'. <!-- begin-user-doc --> This implementation
	 ...
	 *         <em>UI Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseUIConfiguration(final UIConfiguration object) {
		return null;
	}
