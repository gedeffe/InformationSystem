 ...
 * @generated
 */
public class TypesDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, TypesDefinitionPropertiesEditionPart {
	 ...
	 */
	public TypesDefinitionPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public TypesDefinitionPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    propertiesSection.setText(EnvironmentMessages.TypesDefinitionPropertiesEditionPart_PropertiesGroupLabel);
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              TypesDefinitionPropertiesEditionPartForm.this,
              EnvironmentViewsRepository.TypesDefinition.Properties.description,
    ...
    description.addKeyListener(new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent e) {
        if (e.character == SWT.CR) {
          if (propertiesEditionComponent != null)
            propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TypesDefinitionPropertiesEditionPartForm.this, EnvironmentViewsRepository.TypesDefinition.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
        }
      }
    });
    EditingUtils.setID(description, EnvironmentViewsRepository.TypesDefinition.Properties.description);
    EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
    FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EnvironmentViewsRepository.TypesDefinition.Properties.description, EnvironmentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
