 ...
 * @generated
 */
public class PriorityPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, PriorityPropertiesEditionPart {
	 ...
	 */
	public PriorityPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public PriorityPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
    ...
    propertiesSection.setText(EnvironmentMessages.PriorityPropertiesEditionPart_PropertiesGroupLabel);
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              PriorityPropertiesEditionPartForm.this,
              EnvironmentViewsRepository.Priority.Properties.name,
    ...
    name.addKeyListener(new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent e) {
        if (e.character == SWT.CR) {
          if (propertiesEditionComponent != null)
            propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PriorityPropertiesEditionPartForm.this, EnvironmentViewsRepository.Priority.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
        }
      }
    });
    EditingUtils.setID(name, EnvironmentViewsRepository.Priority.Properties.name);
    EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
    FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EnvironmentViewsRepository.Priority.Properties.name, EnvironmentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
    ...
    description.addFocusListener(new FocusAdapter() {
      ...
      public void focusLost(FocusEvent e) {
        if (propertiesEditionComponent != null) {
          propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
              PriorityPropertiesEditionPartForm.this,
              EnvironmentViewsRepository.Priority.Properties.description,
    ...
    description.addKeyListener(new KeyAdapter() {
      ...
      public void keyPressed(KeyEvent e) {
        if (e.character == SWT.CR) {
          if (propertiesEditionComponent != null)
            propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PriorityPropertiesEditionPartForm.this, EnvironmentViewsRepository.Priority.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
        }
      }
    });
    EditingUtils.setID(description, EnvironmentViewsRepository.Priority.Properties.description);
    EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
    FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(EnvironmentViewsRepository.Priority.Properties.description, EnvironmentViewsRepository.FORM_KIND), null); //$NON-NLS-1$
