...
import org.obeonetwork.dsl.environment.components.InterDSMLinkInterDSMLinkPropertiesEditionComponent;
import org.obeonetwork.dsl.environment.components.InterDSMLinkPropertiesEditionComponent;
...
public class InterDSMLinkPropertiesEditionProvider extends PropertiesEditingProviderImpl {
	 ...
	 */
	public InterDSMLinkPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public InterDSMLinkPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof InterDSMLink) {
			if (InterDSMLinkInterDSMLinkPropertiesEditionComponent.INTERDSMLINK_PART.equals(part)
				&& refinement == InterDSMLinkInterDSMLinkPropertiesEditionComponent.class)
				return new InterDSMLinkInterDSMLinkPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
			if (MetadataCptPropertiesEditionComponent.METADATAS_PART.equals(part)
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && EnvironmentPackage.Literals.INTER_DSM_LINK == eObj.eClass();
		}
