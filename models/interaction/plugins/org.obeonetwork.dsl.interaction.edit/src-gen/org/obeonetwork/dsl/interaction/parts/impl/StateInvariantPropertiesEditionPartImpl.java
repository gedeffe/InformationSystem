...
public class StateInvariantPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, StateInvariantPropertiesEditionPart {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(InteractionMessages.StateInvariantPropertiesEditionPart_PropertiesGroupLabel);
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StateInvariantPropertiesEditionPartImpl.this, InteractionViewsRepository.StateInvariant.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
	...
	protected Composite createDescriptionText(Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(StateInvariantPropertiesEditionPartImpl.this, InteractionViewsRepository.StateInvariant.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
			}
