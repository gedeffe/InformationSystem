...
import org.obeonetwork.dsl.statemachine.components.FinalStateFinalStatePropertiesEditionComponent;
import org.obeonetwork.dsl.statemachine.components.FinalStatePropertiesEditionComponent;
...
public class FinalStatePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof FinalState) 
					&& (StateMachinePackage.Literals.FINAL_STATE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && StateMachinePackage.Literals.FINAL_STATE == eObj.eClass();
		}
