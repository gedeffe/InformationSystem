...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.cinematic.toolkits.Toolkit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ToolkitItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Toolkit_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Toolkit_name_feature", "_UI_Toolkit_type"),
				 ToolkitsPackage.Literals.TOOLKIT__NAME,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Toolkit"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_Toolkit_type") :
			getString("_UI_Toolkit_type") + " " + label;
	}
