...
/**
 * This is the item provider adapter for a {@link org.obeonetwork.dsl.cinematic.view.ViewElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewElement_required_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewElement_required_feature", "_UI_ViewElement_type"),
				 ViewPackage.Literals.VIEW_ELEMENT__REQUIRED,
				 true,
				 false,
				 false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewElement_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewElement_type_feature", "_UI_ViewElement_type"),
				 ViewPackage.Literals.VIEW_ELEMENT__TYPE,
				 true,
				 false,
				 true,
				 null,
