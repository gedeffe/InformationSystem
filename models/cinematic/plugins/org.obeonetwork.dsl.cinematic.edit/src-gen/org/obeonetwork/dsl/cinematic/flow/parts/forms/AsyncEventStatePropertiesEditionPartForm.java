 ...
 * @generated
 */
public class AsyncEventStatePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, AsyncEventStatePropertiesEditionPart {
	 ...
	 */
	public AsyncEventStatePropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public AsyncEventStatePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(FlowMessages.AsyncEventStatePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AsyncEventStatePropertiesEditionPartForm.this,
							FlowViewsRepository.AsyncEventState.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, FlowViewsRepository.AsyncEventState.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FlowViewsRepository.AsyncEventState.Properties.name, FlowViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createActionsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.actions = new ReferencesTable(getDescription(FlowViewsRepository.AsyncEventState.Properties.actions, FlowMessages.AsyncEventStatePropertiesEditionPart_ActionsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.actions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				actions.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.actions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				actions.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.actions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				actions.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.actions, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				actions.refresh();
			}
		...
		this.actions.setHelpText(propertiesEditionComponent.getHelpContent(FlowViewsRepository.AsyncEventState.Properties.actions, FlowViewsRepository.FORM_KIND));
		this.actions.createControls(parent, widgetFactory);
		this.actions.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.actions, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, FlowViewsRepository.AsyncEventState.Properties.description, FlowMessages.AsyncEventStatePropertiesEditionPart_DescriptionLabel);
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							AsyncEventStatePropertiesEditionPartForm.this,
							FlowViewsRepository.AsyncEventState.Properties.description,
		...
		description.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(AsyncEventStatePropertiesEditionPartForm.this, FlowViewsRepository.AsyncEventState.Properties.description, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, description.getText()));
				}
			}
		});
		EditingUtils.setID(description, FlowViewsRepository.AsyncEventState.Properties.description);
		EditingUtils.setEEFtype(description, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(FlowViewsRepository.AsyncEventState.Properties.description, FlowViewsRepository.FORM_KIND), null); //$NON-NLS-1$
