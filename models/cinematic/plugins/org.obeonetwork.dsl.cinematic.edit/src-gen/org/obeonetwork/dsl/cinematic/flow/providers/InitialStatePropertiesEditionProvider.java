...
import org.obeonetwork.dsl.cinematic.flow.components.InitialStateInitialStatePropertiesEditionComponent;
import org.obeonetwork.dsl.cinematic.flow.components.InitialStatePropertiesEditionComponent;
 ...
 * @generated
 */
public class InitialStatePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof InitialState) 
					&& (FlowPackage.Literals.INITIAL_STATE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && FlowPackage.Literals.INITIAL_STATE == eObj.eClass();
		}
