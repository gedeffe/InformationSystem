 ...
 * <ul>
 *   <li>{@link org.obeonetwork.dsl.cinematic.flow.impl.FlowStateImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FlowStateImpl extends CinematicElementImpl implements FlowState {
	...
	protected EClass eStaticClass() {
		return FlowPackage.Literals.FLOW_STATE;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case FlowPackage.FLOW_STATE__ACTIONS:
				getActions().clear();
				getActions().addAll((Collection<? extends FlowAction>)newValue);
				return;
		}
