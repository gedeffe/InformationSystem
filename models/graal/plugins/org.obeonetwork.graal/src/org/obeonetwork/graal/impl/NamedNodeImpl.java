 ...
 * <ul>
 *   <li>{@link org.obeonetwork.graal.impl.NamedNodeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedNodeImpl extends NodeImpl implements NamedNode {
	...
	protected EClass eStaticClass() {
		return GraalPackage.Literals.NAMED_NODE;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (derivedFeatureID) {
				case GraalPackage.NAMED_NODE__NAME: return GraalPackage.NAMED_ELEMENT__NAME;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == NamedElement.class) {
			switch (baseFeatureID) {
				case GraalPackage.NAMED_ELEMENT__NAME: return GraalPackage.NAMED_NODE__NAME;
				default: return -1;
			}
		}
