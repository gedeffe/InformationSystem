 ...
 * 
 */
public class RequirementEditorMessages extends NLS {
	
	private static final String BUNDLE_NAME = "org.obeonetwork.dsl.requirement.providers.requirementEditorMessages"; //$NON-NLS-1$
	...
	static {
		...
		NLS.initializeMessages(BUNDLE_NAME, RequirementEditorMessages.class);
	}

	
	private RequirementEditorMessages() {
