 ...
 *******************************************************************************/
package org.obeonetwork.dsl.cinematic.gen.java.struts.architecture.main;
...
/**
 * Entry point of the 'StrutsArchitecture' generation module.
 *
 * @generated
 */
public class StrutsArchitecture extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/cinematic/gen/java/struts/architecture/main/strutsArchitecture";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "strutsArchitecture" };
     ...
     * @generated
     */
    public StrutsArchitecture(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public StrutsArchitecture(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                StrutsArchitecture generator = new StrutsArchitecture(modelURI, folder, arguments);
    ...
    public List<String> getProperties() {
    	...
    	String defaultPropertiesFile = AcceleoPropertiesUtils.PLATFORM_PLUGIN + CinematicArchitecturePlugin.PLUGIN_ID + CinematicArchitecturePlugin.ORG_OBEONETWORK_DSL_CINEMATIC_GEN_JAVA_STRUTS_ARCHITECTURE_COMMON_DEFAULT_PROPERTIES; 
