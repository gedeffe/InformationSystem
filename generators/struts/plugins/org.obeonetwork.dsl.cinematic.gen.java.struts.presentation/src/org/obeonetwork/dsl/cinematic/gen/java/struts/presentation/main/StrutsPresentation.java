 ...
 *******************************************************************************/
package org.obeonetwork.dsl.cinematic.gen.java.struts.presentation.main;
...
/**
 * Entry point of the 'StrutsPresentation' generation module.
 *
 * @generated
 */
public class StrutsPresentation extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/cinematic/gen/java/struts/presentation/main/strutsPresentation";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "strutsPresentation" };
     ...
     * @generated
     */
    public StrutsPresentation(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public StrutsPresentation(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                StrutsPresentation generator = new StrutsPresentation(modelURI, folder, arguments);
    ...
    public List<String> getProperties() {
    	...
    	String defaultPropertiesFile = "platform:/plugin/" + CinematicArchitecturePlugin.PLUGIN_ID + CinematicArchitecturePlugin.ORG_OBEONETWORK_DSL_CINEMATIC_GEN_JAVA_STRUTS_ARCHITECTURE_COMMON_DEFAULT_PROPERTIES; 
