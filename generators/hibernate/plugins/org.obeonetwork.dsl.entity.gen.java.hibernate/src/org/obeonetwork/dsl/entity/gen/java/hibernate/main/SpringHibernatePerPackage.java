...
/**
 * Entry point of the 'SpringHibernatePerPackage' generation module.
 *
 * @generated
 */
public class SpringHibernatePerPackage extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/hibernate/main/springHibernatePerPackage";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "springHibernatePerPackageRoot" };
  ...
  /**
	 ...
	 * @generated
	 */
	public SpringHibernatePerPackage() {
	 ...
	 * @generated
	 */
	public SpringHibernatePerPackage(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public SpringHibernatePerPackage(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                SpringHibernatePerPackage generator = new SpringHibernatePerPackage(modelURI, folder, arguments);
