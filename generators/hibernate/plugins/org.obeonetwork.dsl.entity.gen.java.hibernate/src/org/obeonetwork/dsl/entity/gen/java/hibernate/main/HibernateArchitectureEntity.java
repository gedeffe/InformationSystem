...
/**
 * Entry point of the 'HibernateArchitectureEntity' generation module.
 *
 * @generated
 */
public class HibernateArchitectureEntity extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/hibernate/main/hibernateArchitectureEntity";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "hibernateArchitectureEntity" };
  ...
  /**
	 ...
	 * @generated
	 */
	public HibernateArchitectureEntity() {
	 ...
	 * @generated
	 */
	public HibernateArchitectureEntity(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public HibernateArchitectureEntity(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                HibernateArchitectureEntity generator = new HibernateArchitectureEntity(modelURI, folder, arguments);
