...
/**
 * Entry point of the 'SpringHibernatePerEntity' generation module.
 *
 * @generated
 */
public class SpringHibernatePerEntity extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/hibernate/main/springHibernatePerEntity";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "springHibernatePerEntity" };
  ...
  /**
	 ...
	 * @generated
	 */
	public SpringHibernatePerEntity() {
	 ...
	 * @generated
	 */
	public SpringHibernatePerEntity(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public SpringHibernatePerEntity(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                SpringHibernatePerEntity generator = new SpringHibernatePerEntity(modelURI, folder, arguments);
