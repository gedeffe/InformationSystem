...
/**
 * Entry point of the 'DaoApiDirect' generation module.
 *
 * @generated
 */
public class DaoApiDirect extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/dao/main/daoApiDirect";
     ...
     * @generated
     */
    public DaoApiDirect(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public DaoApiDirect(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                DaoApiDirect generator = new DaoApiDirect(modelURI, folder, arguments);
