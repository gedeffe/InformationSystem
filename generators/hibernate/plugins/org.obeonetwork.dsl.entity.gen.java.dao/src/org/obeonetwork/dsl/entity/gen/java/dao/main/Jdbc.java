...
/**
 * Entry point of the 'Jdbc' generation module.
 *
 * @generated
 */
public class Jdbc extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/dao/main/jdbc";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "jdbc" };
  ...
  /**
	 ...
	 * @generated
	 */
	public Jdbc(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public Jdbc(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Jdbc generator = new Jdbc(modelURI, folder, arguments);
