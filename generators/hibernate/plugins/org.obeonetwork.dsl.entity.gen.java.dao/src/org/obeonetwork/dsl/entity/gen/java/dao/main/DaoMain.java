...
/**
 * Entry point of the 'DoaMain' generation module.
 *
 * @generated
 */
public class DaoMain extends AbstractAcceleoGenerator {
	/**
	 * The name of the module.
	 *
	 * @generated
	 */
	public static final String MODULE_FILE_NAME = "/org/obeonetwork/dsl/entity/gen/java/dao/main/daoMain";
	 ...
	 * @generated
	 */
	public static final String[] TEMPLATE_NAMES = { "doaMain" };
  ...
  /**
	 ...
	 * @generated
	 */
	public DaoMain(URI modelURI, File targetFolder,
	 ...
	 * @generated
	 */
	public DaoMain(EObject model, File targetFolder,
			List<? extends Object> arguments) throws IOException {
	...
	public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                DaoMain generator = new DaoMain(modelURI, folder, arguments);
